...
-define(BIND(Length, ComId, SeqNum, SysId, LenId, Pass, LenP, SysType, LenT, IntVer, AddrTon, AddrNpi, AddrRange, LenR), <<
...
-define(SUBMIT_SM(Length, SeqNum, ServType, LenT, SAddrTon, SAddrNpi, SAdress, LenS, DAddrTon, DAddrNpi, DAddr, LenD, DataCoding, LenSms, Text), <<
    Length:32/integer,                 %% command_length
...
-define(SUBMIT_SM_CUT(Length, SeqNum, ServType, LenT, SAddrTon, SAddrNpi, SAdress, LenS, DAddrTon, DAddrNpi, DAddr, LenD, DataCoding, LenMsg, Chunk, LenChunk, SarRefNum, SarSegNum, SarTotSeg, DlrRequired), <<
    Length:32/integer,                 %% command_length
    4:32/integer,                      %% command_id
    0:32/integer,                      %% command_status NONE in native packet !!!!!
    SeqNum:32/integer,                 %% sequence_number
...
-define(SUBMIT_SM_MSG_PAYLOAD(Length, SeqNum, ServType, LenT, SAddrTon, SAddrNpi, SAdress, LenS, DAddrTon, DAddrNpi, DAddr, LenD, DataCoding, LenSms, Text), <<
    Length:32/integer,                 %% command_length
    4:32/integer,                      %% command_id
    0:32/integer,                      %% command_status NONE in native packet !!!!!
    SeqNum:32/integer,                 %% sequence_number
...
-define(DATA_SM(Length, SeqNum, ServType, LenT, SAddrTon, SAddrNpi, SAdress, LenS, DAddrTon, DAddrNpi, DAddr, LenD, DataCoding, Payload, PayLen), <<
    Length:32/integer,                 %% command_length
...
-define(CANCEL_SM(Length, SeqNum, MsgId, LenId, SAddrTon, SAddrNpi, SAdress, LenS, DAddrTon, DAddrNpi, DAddr, LenD), <<
    Length:32/integer,                %% command_length
...
-define(REPLACE_SM(Length, SeqNum, MsgId, LenId, SAddrTon, SAddrNpi, SAdress, LenS, LenTxt, Txt), <<
    Length:32/integer,                %% command_length
